...
serviceName = 'micro-user'
service = 'Freelance Users'
...
pipeline{
    ...
    environment{
        ...
        IMAGE_NAME = 'ashishnewar' + '/' + 'freelance-user'
    ...
    stages{
        ...
        stage('Prepare Environment'){
            steps{
                ...
                git branch: 'main', credentialsId: 'github', url: 'https://github.com/AshNewar/freelance-User'
                sh 'npm install'
            }
        }
